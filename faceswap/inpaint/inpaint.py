...
def main():
	...
	with torch.inference_mode():
		...
		loadimage_239 = loadimage.load_image(image="clipspace/clipspace-mask-26662.png [input]")
		...
		loadimage_240 = loadimage.load_image(image="IMG_7822 (1).jpg")
		...
		for q in range(1):
			...
			saveimage_413 = saveimage.save_images(filename_prefix="AceFaceSwap/Faceswap", images=get_value_at_index(inpaintstitch_412, 0))
